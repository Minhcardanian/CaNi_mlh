...
This package deploys or joins the fixed NightPermit Compact contract and submits one private reviewer approval. It validates every constructor byte width, the unsigned tranche bound, distinct reviewer commitments, and the local reviewer secret before any deployment or approval transaction.
