...
Current project state, safe evidence, and blockers are recorded in `docs/execution/`.

## Repository safety

Never commit secrets, wallet material, private witnesses, environment values, node or proof state, personal data, `.codex`, AI session artifacts, prompts, transcripts, scratchpads, or generated AI reports.
